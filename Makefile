...
all: y.tab.c lex.yy.c symbol_table.o inter_code_gen.o converter.o register.o repr_utils.o
	gcc $(CFLAGS) y.tab.c lex.yy.c symbol_table.o inter_code_gen.o converter.o register.o repr_utils.o -o $(OUT_FILE) $(WITH_GLIB)
